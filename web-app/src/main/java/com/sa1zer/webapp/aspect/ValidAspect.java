package com.sa1zer.webapp.aspect;

import com.sa1zer.webapp.annotation.*;
import com.sa1zer.webapp.annotation.NotNull;
import com.sa1zer.webapp.annotation.Valid;
import com.sa1zer.webapp.exeption.ValidationException;
...
public class ValidAspect {
     ...
     */
    @Pointcut("execution(* *(.., @com.sa1zer.webapp.annotation.Valid (*), ..))")
